...
export default function Games({ypos, onscrollstop}) {
    ...
    React.useEffect(() => {
        ...
        if(ypos < cur.offsetTop){
            ...
            if(yInsidePos!==pos) setPos(yInsidePos);
        }
    }, [ypos]);
    ...
    return(<section ref={sectionref} className="relative" id="games">
        <div className={"min-h-screen table w-full bg-green-600 "+style} >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex">
                    ...
                    <div className="w-3/5 text-right">
                        <p className="text-3xl mb-7">Adventure of Hanacaraka</p>
                        <p className="text-base mb-7">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                        <div className="block">
                            <span>
